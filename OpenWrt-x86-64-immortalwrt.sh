...
# 更新feeds文件
#sed -i 's#src-git luci https://github.com/Lienol/openwrt-luci.git;21.02#src-git luci #https://github.com/Lienol/openwrt-luci.git;19.07#g' feeds.conf.default #更换luci版本
